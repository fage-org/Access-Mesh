 ...
 */
@Service
public class PermissionVersionAppServiceImpl implements PermissionVersionAppService {
     ...
     */
    public PermissionVersionAppServiceImpl(TypeResolutionService typeResolutionService,
