 ...
 * 权限失效广播事件
 * <p>
 * permission-center 写路径事务提交后由 {@link PermissionChangeAspect} 通过 Redis pub/sub
 * （topic: {@code perm:invalidate}）广播。Gateway 订阅后据此 evict 本地 INTERFACE_SNAPSHOT 缓存。
 * </p>
 * <p>
 ...
 */
public record PermInvalidateEvent(Long tenantId, Set<Long> roleIds, Set<Long> userIds, Set<String> serviceCodes) implements Serializable {
}
