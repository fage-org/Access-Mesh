...
public class LoginLogController {
    ...
    @PostMapping("/page")
    public PermResult<PaginatedResult<SysLoginLog>> pageLoginLogs(@RequestBody PageReq pageReq) {
        return PermResult.success(loginLogService.pageLoginLogs(pageReq));
    }
}
