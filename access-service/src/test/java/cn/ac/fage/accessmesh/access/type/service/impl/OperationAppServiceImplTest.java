...
class OperationAppServiceImplTest {
    ...
    void shouldGetTypedOperationByBusinessKey() {
        try (MockedStatic<OperatorContext> operatorContext = mockStatic(OperatorContext.class)) {
            ...
            assertEquals("VIEW", service.getOperation(1L,
                new cn.ac.fage.accessmesh.access.type.dto.req.OperationKeyReq("ROLE", "VIEW")).code());
        }
    }
    ...
    void shouldUpdateOperationByBusinessKey() {
        ...
        cn.ac.fage.accessmesh.access.type.dto.resp.OperationPermissionResp resp = service.updateOperation(1L,
            new cn.ac.fage.accessmesh.access.type.dto.req.OperationUpdateReq("ROLE", "MANAGE", "管理", 16L, 2L), 100L);
    ...
    void shouldDeleteOperationsByBusinessKeyUtil() {
        ...
        service.deleteOperations(1L, List.of(
            new cn.ac.fage.accessmesh.access.type.dto.req.OperationKeyReq("ROLE", "VIEW"),
            new cn.ac.fage.accessmesh.access.type.dto.req.OperationKeyReq("ROLE", "MISSING")), 100L);
    ...
    void shouldNotDeleteCartesianSupersetRowsForSparseMultiTypeKeys() {
        ...
        service.deleteOperations(1L, List.of(
            new cn.ac.fage.accessmesh.access.type.dto.req.OperationKeyReq("ROLE", "VIEW"),
            new cn.ac.fage.accessmesh.access.type.dto.req.OperationKeyReq("USER", "DELETE")), 100L);
    ...
    void shouldMigrateSeedWhenCustomTypeOperationBitChanged() {
        ...
        service.updateOperation(1L, new cn.ac.fage.accessmesh.access.type.dto.req.OperationUpdateReq(
    ...
    void shouldCascadeSeedRemovalOnCustomTypeOperationDelete() {
        ...
        cn.ac.fage.accessmesh.access.type.entity.OperationPermission audit =
            new cn.ac.fage.accessmesh.access.type.entity.OperationPermission();
        audit.setId(32L);
        ...
        cn.ac.fage.accessmesh.access.type.entity.TypeDefinition orderTd = customType(12, false);
        ...
        service.deleteOperations(1L, java.util.List.of(
            new cn.ac.fage.accessmesh.access.type.dto.req.OperationKeyReq("ORDER", "EXPORT"),
            new cn.ac.fage.accessmesh.access.type.dto.req.OperationKeyReq("SERVICE", "AUDIT")), 100L);
    ...
    void shouldSkipEvictionWhenDeleteResolvesNoEntities() {
        ...
        service.deleteOperations(1L, List.of(
            new cn.ac.fage.accessmesh.access.type.dto.req.OperationKeyReq("ROLE", "VIEW")), 100L);
