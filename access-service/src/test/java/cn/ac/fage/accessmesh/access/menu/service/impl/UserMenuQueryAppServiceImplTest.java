...
class UserMenuQueryAppServiceImplTest {
    ...
    private UserMenuQueryAppServiceImpl service;
    ...
    void effectivePermissionWhitelistCoversFrontendConsumedCodes() throws Exception {
        ...
        var field = UserMenuQueryAppServiceImpl.class.getDeclaredField("EFFECTIVE_PERMISSION_CODE_RESOURCE_TYPES");
