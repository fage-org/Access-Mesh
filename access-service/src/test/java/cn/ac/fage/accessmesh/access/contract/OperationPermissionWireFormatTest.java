...
class OperationPermissionWireFormatTest {
    ...
    void shouldDeserializeStringBitsIntoLong() throws Exception {
        ...
        cn.ac.fage.accessmesh.access.type.dto.req.OperationUpdateReq req =
            objectMapper.readValue(json, cn.ac.fage.accessmesh.access.type.dto.req.OperationUpdateReq.class);
