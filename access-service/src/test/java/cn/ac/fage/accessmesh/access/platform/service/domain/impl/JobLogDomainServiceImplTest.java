package cn.ac.fage.accessmesh.access.platform.service.domain.impl;
 ...
 * （JobAppServiceImpl.executeJob finally）统一 try-catch 兜底隔离（评审 P1-3 修复）。
 * </p>
 */
...
class JobLogDomainServiceImplTest {
    ...
    void shouldPropagateExceptionWhenInsertFails() {
        ...
        // 由调用方（JobAppServiceImpl.executeJob finally）try-catch 兜底隔离。
