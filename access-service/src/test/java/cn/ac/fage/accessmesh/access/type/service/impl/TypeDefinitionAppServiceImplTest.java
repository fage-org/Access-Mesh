...
class TypeDefinitionAppServiceImplTest {
    ...
    void setUp() {
        ...
        cn.ac.fage.accessmesh.access.type.service.domain.ResourceTypeOwnershipGuard ownershipGuard =
    ...
    void shouldPresetCrudOperationsWhenCreatingResourceType() {
        ...
        ArgumentCaptor<List<cn.ac.fage.accessmesh.access.type.entity.OperationPermission>> opCaptor =
            ArgumentCaptor.forClass(List.class);
        verify(operationPermissionMapper).insertBatch(opCaptor.capture());
        List<cn.ac.fage.accessmesh.access.type.entity.OperationPermission> preset = opCaptor.getValue();
    ...
    private static cn.ac.fage.accessmesh.access.resource.entity.ServiceConfig registeredEnabledService() {
        cn.ac.fage.accessmesh.access.resource.entity.ServiceConfig config =
            new cn.ac.fage.accessmesh.access.resource.entity.ServiceConfig();
        config.setStatus(1);
    ...
    void shouldCascadeOperationsAndTypeLevelGrantsOnResourceTypeDelete() {
        ...
        when(resourceEntityDomainService.findTypesWithValidRows(1L, java.util.Set.of(5)))
            .thenReturn(java.util.Set.of());
        cn.ac.fage.accessmesh.access.type.entity.OperationPermission create =
    ...
    void shouldMigrateAuthorityRootWhenOwnerPointerChanged() {
        ...
        when(grantOriginDomainService.parseGrantOriginPointer(oldExtra))
            .thenReturn(new cn.ac.fage.accessmesh.access.grant.service.domain.GrantOriginDomainService.GrantOriginRole(
