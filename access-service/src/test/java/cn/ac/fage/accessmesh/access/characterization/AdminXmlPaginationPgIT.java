...
import cn.ac.fage.accessmesh.access.platform.service.impl.ConfigAppServiceImpl;
...
class AdminXmlPaginationPgIT {
    ...
    @Autowired
    private ConfigAppServiceImpl configService;
    @Autowired
    ...
    void shouldAssemblePageRespMetadataViaConfigService() {
        ...
        PageResp<cn.ac.fage.accessmesh.access.platform.dto.resp.ConfigResp> firstPage =
        ...
        PageResp<cn.ac.fage.accessmesh.access.platform.dto.resp.ConfigResp> exactLastPage =
            configService.pageConfigs(PageReq.of(2, 2));
        assertThat(exactLastPage.items()).hasSize(2);
        assertThat(exactLastPage.hasNext()).isFalse();

        PageResp<cn.ac.fage.accessmesh.access.platform.dto.resp.ConfigResp> beyondLast =
