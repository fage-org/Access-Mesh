...
public final class AccessCacheCatalog {
    ...
    public static final CacheCatalogEntry<List<cn.ac.fage.accessmesh.access.engine.vo.RolePermEntry>> ROLE_PERM_SNAPSHOT =
        CacheCatalogEntry.<List<cn.ac.fage.accessmesh.access.engine.vo.RolePermEntry>>builder()
            .code("perm:role-perm-snapshot")
            .mode(CacheMode.L2_ONLY)
            .l2Ttl(Duration.ofSeconds(10))
            .valueType(new TypeRef<List<cn.ac.fage.accessmesh.access.engine.vo.RolePermEntry>>() {})
            .build();
     ...
     * </p>
     */
    public static final CacheCatalogEntry<Map<Long, cn.ac.fage.accessmesh.access.type.entity.OperationPermission>> OPERATION_PERMISSIONS_BY_TYPE =
        CacheCatalogEntry.<Map<Long, cn.ac.fage.accessmesh.access.type.entity.OperationPermission>>builder()
            .code("perm:operation-permissions-by-type")
            .mode(CacheMode.L1_L2)
            .l1Ttl(Duration.ofMinutes(60))
            .l1MaxSize(100)
            .l2Ttl(Duration.ofMinutes(120))
            .valueType(new TypeRef<Map<Long, cn.ac.fage.accessmesh.access.type.entity.OperationPermission>>() {})
            .build();
