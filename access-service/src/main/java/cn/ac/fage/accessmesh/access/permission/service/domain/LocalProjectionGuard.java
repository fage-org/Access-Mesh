 ...
 * 类型级所有权门禁——事实链路类型（USER/ORG/MENU/ROLE/ADMIN_FILE/TYPE_DEFINITION/CONDITION）种子声明 SYNC+access-service，
 * T-PERM-052 2026-09-05、T-ADMIN-025 增 ADMIN_FILE、T-PERM-051 增 TYPE_DEFINITION、T-PERM-048 增 CONDITION）。
 */
@Component
