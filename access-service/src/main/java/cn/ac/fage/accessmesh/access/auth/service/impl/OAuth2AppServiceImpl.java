...
import cn.ac.fage.accessmesh.access.auth.dto.*;
...
public class OAuth2AppServiceImpl implements OAuth2AppService {
    ...
    private static final Logger log = LoggerFactory.getLogger(OAuth2AppServiceImpl.class);
     ...
     */
    public OAuth2AppServiceImpl(OAuth2ClientDomainService oauth2ClientDomainService,
