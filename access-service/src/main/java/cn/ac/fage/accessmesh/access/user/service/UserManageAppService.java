...
public interface UserManageAppService {
     ...
     * @return 创建的用户详情
     */
    AbstractUserResp createUser(Long tenantId, AbstractUserCreateReq req);
     ...
     * @return 更新后的用户详情
     */
    AbstractUserResp updateUser(Long tenantId, AbstractUserUpdateReq req);
     ...
     * @return 用户详情
     */
    AbstractUserResp getUser(Long tenantId, Long userId);
     ...
     * @return 用户列表
     */
    List<AbstractUserResp> listUsers(Long tenantId, String subjectTypeCode, String domainCode, String keyword, int offset, int limit);
