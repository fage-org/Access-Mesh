...
| [T-FE-047](T-FE-047.md) | 用户删除二次确认与错误反馈（✅ 2026-09-19 收口：handleDelete 确认弹窗+失败错误反馈，hook 层两入口全覆盖；红跑 3 锁全红实证） | [frontend-session-consistency](../plans/frontend-session-consistency-plan.md) | — | — | ✅ | — |
