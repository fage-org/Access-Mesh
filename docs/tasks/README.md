...
| [T-FE-058](../archive/2026-09-24/tasks/T-FE-058.md) | 岗位与成员角色候选分页闭合 | ✅（2026-09-23 收口：三项拍板〔U005 迁移 /abstract-role/list+同批退役 /role/list 链/bootstrap 行/runbook 订正、选择器=el-select remote+下拉内翻页、Q-035/Q-036 随卡收敛〕+红跑实证+浏览器四场景三截图+双轨评审处置（代码 P3×4/文档 P2×3+P3×7 直修、裁剪×2 拍板删、Q-042 登记）+全量含 E2E/heavy 1993 项 0 失败；定案见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行） | — |
| [T-API-004](../archive/2026-09-24/tasks/T-API-004.md) | 可编辑字段显式清空协议贯通 | ✅（2026-09-24 收口：U006 四项拍板〔冲突全端点拒绝/type extraClear 拒清/空串拒 400/范围=六字段+perm 轨 extra〕+红跑实证（服务回退 HEAD PgIT 5 红+单测 1 红、门禁修复 1 红）+双轨评审处置完毕（P1 门禁漏计 extraClear 补锁+错误码 20044 校准等九项）+全量含 E2E BUILD SUCCESS 0 失败；定案见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行，同型矩阵登记 Q-043） | — |
| [T-ADMIN-029](../archive/2026-09-24/tasks/T-ADMIN-029.md) | 公告状态与受众生命周期闭合 | ✅ | — |
| [T-FE-059](../archive/2026-09-24/tasks/T-FE-059.md) | 共享列表上下文与可写对象绑定 | ✅（2026-09-23 收口：loader contextKey/clear/onClear 四消费面接线+保存时核对层拍板「加」〔逐入口守卫〕；双轨评审 P1 哨兵归一/P2 submitMove 直修红跑实证、claude 外评 P0-P2=0/P3 计数漂移去计数化、过度设计可裁剪 1 项留拍板；vitest 全绿+typecheck/lint/build 0+浏览器三截图证据；定案与处置见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日两行） | — |
| [T-GW-010](../archive/2026-09-24/tasks/T-GW-010.md) | 开发与代理拓扑的 Origin 接入一致性 | ✅（2026-09-23 收口：白名单四条全放+端口维持 8848 两项拍板、四形态浏览器登录+nginx 同源实测、三态诊断表、全量含 E2E 1994 绿；定案与处置见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行） | — |
...
| [T-ACCESS-053](../archive/2026-09-24/tasks/T-ACCESS-053.md) | 首次服务接入与撤销验证路径简化 | ✅（2026-09-23 收口：四项拍板〔U008 维持现状登记 Q-040/撤销主线 E2E⑧+文档/compose 空环境实测/文档改现有不新建，[历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行〕+E2E⑧撤销→403→重授→200+五册接入文档统一+空环境实测主线/业务类型授权根/两套身份全链证据+双轨评审处置完毕（代码轨 P3×3/文档轨 P2×2+P3×4 全直修、Q-041 登记）+全量含 E2E/heavy BUILD SUCCESS 0 失败） | T-GW-010 |
| [T-PERM-078](../archive/2026-09-24/tasks/T-PERM-078.md) | 自动授权实施前协议与算法校准 | ✅ | — |
| [T-ACCESS-054](../archive/2026-09-24/tasks/T-ACCESS-054.md) | 外围任务能力与缓存过渡机制取舍 | ✅（2026-09-24 收口：两项拍板〔U010 底座保留+ADMIN_JOB 最小运营三档种子 VIEW/TRIGGER/ENABLE+job 三读端点补 VIEW 门禁、U011 legacy 别名随过渡窗口关闭整体删除——用户确认无旧构建实例在跑〕+红跑实证〔读门禁回退 2/2 红/种子回退计数红/GRANT_RESOURCE_TYPES 缺项 fail-fast 实证〕+单测轨 1397 绿；定案见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行） | — |
| [T-ACCESS-055](../archive/2026-09-24/tasks/T-ACCESS-055.md) | 核心用户任务组合验收与文档收口 | ✅（2026-09-24 收口：五项拍板〔载体=全组合 PgIT/双视角浏览器/Q-034 维持登记/自动化重跑+手工引用/视角 B 缺口=前端修+后端实例准入翻 052 半边登记〕+三新组合 PgIT 红跑 3/3〔条件变更/岗位剪枝/双租户同码〕+双视角浏览器实测〔A 分配链全链+改密链顺路、B 判定面+缺口修复复验三截图〕+双轨评审处置〔代码轨 P3×6/文档轨 P1×1+P2×6+P3×8〕+全量含 E2E/heavy BUILD SUCCESS 0 失败+前端四件套全绿；证据 evidence/t-access-055/；定案见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行含翻案行） | T-ORG-002, T-ADMIN-028, T-PERM-074, T-PERM-075, T-PERM-076, T-FE-057, T-FE-058, T-API-004, T-ADMIN-029, T-FE-059, T-PERM-077, T-ACCESS-052, T-ACCESS-053 |

### 定案治理

| ID | 标题 | 状态 | 直接依赖 |
|---|---|---|---|
| [T-ACCESS-064](../archive/2026-09-26/tasks/T-ACCESS-064.md) | 当前规范归位与定案入口轻量化 | ✅（2026-09-26） | T-ACCESS-063 |
...
> [access-capability-fusion-plan](../archive/2026-09-14/access-capability-fusion-plan.md)（已归档 2026-09-14：十任务全 done，三通道外评处置后用户确认定稿）；目标设计 [capability-structure](../design/access-service-capability-structure.md)（**adopted**，2026-09-13 T-ACCESS-032 §8 定稿、十项裁决登记 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行；033 迁移已于 2026-09-13 完成，代码即能力包结构）；定案见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 2026-09-13 两行。
...
> [capability-mapper-convergence-plan](../archive/2026-09-15/capability-mapper-convergence-plan.md)（已归档 2026-09-15，四任务全 done）：冻结白名单 19 类 30 边全量收敛至零并退役断言白名单；定案与新服务硬契约见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 2026-09-15 行；计划内四任务串行（白名单记账串行化），边清单以计划文件「消费类:行号 → mapper#方法」定位为准。
...
> [release-preview-plan](../archive/2026-09-16/release-preview-plan.md)（已归档 2026-09-16，四任务全 done）：首个发布预览（v0.1.0）与部署验证——全栈 compose profile + 发布文档全套 + 空环境部署验证 + 本地 tag v0.1.0；三项定调与双轨评审处置见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 2026-09-16 两行；最终全量回归含 E2E 全绿（1706 项 0 失败）。
...
| [T-ACCESS-050](../archive/2026-09-16/tasks/T-ACCESS-050.md) | 首次部署验证与版本打点收口——空环境全栈冒烟 + v0.1.0 tag + 042 归档 | 同 | release-preview-plan；[历史定案原文](../archive/2026-09-26/decision-registry-before.md) | T-ACCESS-047, T-ACCESS-048, T-ACCESS-049 | ✅ | ✓ |
...
| [T-ACCESS-063](../archive/2026-09-26/tasks/T-ACCESS-063.md) | decision-registry 双册分层与行文瘦身治理 | — | [历史协议](../archive/2026-09-26/decision-registry-before.md) | — | ✅（2026-09-26） | ✓ |
...
| [T-PERM-070](../archive/2026-09-24/tasks/T-PERM-070.md) | 前置·公共服务认证模块（per-service 静态凭证）（✅ 2026-09-20 收口：service_credential 表+管理面四端点+ServiceAuthArbiter 五形态仲裁〔凭证优先/禁止降级/白名单单源〕+Gateway M2M 放行链+SDK 凭证拦截器〔注入面精确镜像+启动声明式 TLS 三态〕+20065~20068+固定图四行；七项拍板见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行；双轨评审 P1×2+P0×5 全处置〔SDK 宽注入面收窄+五处既有锁随批更新〕+E2E 真实 sync 成功用例；全量回归含 E2E 绿） | —（T-PERM-035 实现序列前置卡） | docs/design/service-authentication.md；docs/design/access-service-api-contract.md §24 | — | ✅ | ✓ |
| [T-PERM-071](../archive/2026-09-24/tasks/T-PERM-071.md) | 独立依赖声明与可选 SDK 协调（✅ 2026-09-21 收口：全量含 E2E 1842 项 0 失败；双轨+四任务内外评审处置完毕〔claude P3×3 全处置、风格转出 T-PERM-079、拍板与豁免登记见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日三行〕；迁移未在任何部署库执行） | —（自动授权实施序列） | [简化设计](../design/dependency-auto-grant.md) | T-PERM-070, T-PERM-078, T-PERM-074 | ✅ | ✓ |
| [T-PERM-072](../archive/2026-09-24/tasks/T-PERM-072.md) | 自动授权物化与共享推导 | —（自动授权实施序列） | [简化设计](../design/dependency-auto-grant.md) | T-PERM-071 | ✅ | ✓ |
| [T-PERM-073](../archive/2026-09-24/tasks/T-PERM-073.md) | 按需来源解释、授权界面与对账 | —（自动授权实施序列） | [简化设计](../design/dependency-auto-grant.md) | T-PERM-072 | ✅ | ✅ |
...
| [T-PERM-048](../archive/2026-09-12/tasks/T-PERM-048.md) | 权限条件实例投影与双轨制——管理页条件 vs 授权页内联条件（已收口 2026-09-11，五项定案与终态见任务卡完成记录与 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行） | — | api-contract §5.6；access-service.sql | — | ✅ | ✓ |
...
| [T-PERM-061](../archive/2026-09-12/tasks/T-PERM-061.md) | EXT-7：batchCheck 逐条 engine.query 收敛——A+ 形态「分组 + 请求级共享装载」（已收口 2026-09-11：queryBatch + 条件四态增量快照 + 互斥 ledger 聚合 + 回归锁①-⑪ 全绿；双轨评审处置与父段装载定案见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 实施收口行、遗留登记见任务卡遗留节；实施落点见 implementation §3.10） | — | implementation §3；api-contract §6.1 | — | ✅ | ✓ |
...
| [T-PERM-065](../archive/2026-09-14/tasks/T-PERM-065.md) | Req DTO 副本双轨收敛——14 对同名 Req 与 perm-common 统一（T-PERM-021 F1.b 盘点定性后另立；✅ 2026-09-12 收口：换绑单源 + SDK 契约对齐 + ResourceUpdateReq 业务键形态修复 + 守卫重写注解签名快照；双轨评审全处置，两项拍板见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行） | —（2026-09-12 用户拍板另立任务） | api-contract；project-rules | — | ✅ | ✓ |
...
| [T-PERM-079](../archive/2026-09-21/tasks/T-PERM-079.md) | 自动授权批次风格与可读性清理（070/074/071 触达面）— ✅ 2026-09-21 收口：七项验收全落地（参数组 record/字面量常量化/服务判据单源/分批样板收敛/var 定调=登记允许/次要项/拆档）+两项拍板 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日登记（skipHeavyIT 新开关并入日常形态命令）+收口全量三段全绿（access-service 305+1308 含 heavy/e2e 15）+claude 外评 P3×2 直修；2026-09-21 单卡归档 | —（评审转出单卡） | —（工程改进；[历史定案原文](../archive/2026-09-26/decision-registry-before.md) 2026-09-21 风格定案行） | — | ✅ | ✓ |
...
| [T-API-002](../archive/2026-09-14/tasks/T-API-002.md) | perm-sdk 补齐 auth/query-resources 与 auth/query-scopes 调用入口（已收口 2026-09-06，终态见任务卡完成记录；其内部 id 裁剪的 check 族部分 2026-09-09 被推翻，见 T-API-003 与 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 已推翻节） | [design-audit-followup](../archive/2026-09-14/design-audit-followup-plan.md)（已归档） | core-flows §15；api-contract；perm-sdk | — | ✅ | ✓ |
...
| [T-FE-045](../archive/2026-09-20/tasks/T-FE-045.md) | 登出真注销（接 /auth/logout）（✅ 2026-09-19 收口：logout() 显式携 Authorization 头+http 请求白名单纳入防过期分支递归；logOut 服务端注销优先/本地清理无条件/串行防抖；回归锁×7 红跑实证；login.md 新增登出流程节；claude 外评 P2×1 维持现状+P3×1 登记 Q-016，见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 处置行） | [frontend-session-consistency](../archive/2026-09-20/frontend-session-consistency-plan.md) | design/frontend/login.md | — | ✅ | ✓ |
| [T-FE-046](../archive/2026-09-20/tasks/T-FE-046.md) | 强制改密闭环（自助改密页+阻断）（✅ 2026-09-20 收口：登录写 userId/forceResetPwd 入 userKey+守卫 8 路径放行清单阻断 redirect /change-password+/change-password 页（8-32 位无旧密码）+改密成功清标记会话保留+登录 warning 分支退役；双轨评审 P2×2（/redirect 死项删+补锁、契约/后端注释滞后顺改）+P3×2 全处置；两项拍板（toast 维持现状、E2E 登记计划归档时跑）；红跑 6 红实证；端到端验收（acceptance 第 5 条）2026-09-20 归档批次执行通过（六项判据见归档计划当前进度末行）。claude 外评处置完毕（2026-09-20 模型 deepseek-flash[1m]：P0-P2=0、P3×2 全采纳直修——纯空白密码 whitespace 规则+锁（后端 isBlank 随机替换锁死用户）+登录落点三处文案同步（MemberTab×2 退役口径+半成功「进入系统后」限定）、存量×6 处置（改密页无登出入口注记入卡）；vitest 325/325；定案与明细见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日处置行） | [frontend-session-consistency](../archive/2026-09-20/frontend-session-consistency-plan.md) | design/frontend/login.md | — | ✅ | ✓ |
| [T-FE-047](../archive/2026-09-20/tasks/T-FE-047.md) | 用户删除二次确认与错误反馈（✅ 2026-09-19 收口：handleDelete 确认弹窗+失败错误反馈，hook 层两入口全覆盖；红跑 3 锁全红实证；claude 外评 P0-P2=0/P3×1 已修+存量×2 处置（Q-017+T-FE-051 扩行），见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 处置行） | [frontend-session-consistency](../archive/2026-09-20/frontend-session-consistency-plan.md) | — | — | ✅ | — |
| [T-FE-048](../archive/2026-09-20/tasks/T-FE-048.md) | 会话权限热刷新（403 触发+手动入口）（✅ 2026-09-20 收口：`refreshSessionCapability` 统一入口（权限串+侧栏原子更新，T-FE-056 挂接点预留）四调用方共用（initRouter/403 自动/顶栏手动/retryLoadDeps）；http 拦截器 403 分支 10s 窗口去重+失败静默+不重放+排除 user-menu 自身；顶栏「刷新权限」成功/失败双 message 口径；红跑 8 红/9 绿实证（三把验收锁全红）；双轨评审 P0-P2 代码轨=0/文档轨=P2×1（[历史定案原文](../archive/2026-09-26/decision-registry-before.md) 补登记即本批完成）+P3 处置×5（三项拍板接受/登记 Q-016、重试按钮补 loading 采纳）；claude+codex 双通道外评处置完毕（2026-09-20：claude deepseek-flash[1m] P0-P2=0/P3×1、codex luna max P2×2，逐条亲核成立；两项拍板均登记不修——同会话并发覆盖 Q-016 两变体扩行、mix/horizontal 布局缺口修法定向抽公共组件暂不实施；零代码改动；定案与明细见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日处置行） | [frontend-session-consistency](../archive/2026-09-20/frontend-session-consistency-plan.md) | design/frontend/login.md；design/frontend/permission-grant.md | — | ✅ | ✓ |
| T-FE-049 | 登录半成功语义修正（✅ 2026-09-19 收口：登录提示按菜单状态两态——半成功/零权限 warning 诚实告知（非阻断，`resolveLoginMessages` 唯一出口，T-FE-046 阻断分支扩展点）+ store `menuLoadFailed` 空侧栏两态事实来源 + 占位项/`/menu-retry` 着陆页两态（失败可重试 vs 无可用菜单引导联系管理员）；红跑 9 红实证；双轨评审处置（P2 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 补行+P3×3+Q-020）+ claude 外评处置（P2×1 占位项未注册 name 删+补锁、P3×2 mock 注释/meta.title 中性化、存量图标 2 枚顺带注册+Q-021 登记）；vitest 303/303 全绿） | [frontend-session-consistency](../archive/2026-09-20/frontend-session-consistency-plan.md) | design/frontend/login.md | — | ✅ | ✓ |
| [T-FE-050](../archive/2026-09-20/tasks/T-FE-050.md) | findParentOrgName 递归 bug 修复（仅 user/index.vue）（✅ 2026-09-19 收口：未找到返 null 不剪兄弟子树，提取 utils/orgTree.ts；红跑 4 红 1 绿实证；Q-017 拍板留给 T-FE-051；双轨评审 P0×1+P3×3 处置（rule §2 对齐工具链/Q-018/051 锚点）；claude 外评 P0-P3=0+存量×2（Q-018 注记/Q-019），见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 定案行） | [frontend-session-consistency](../archive/2026-09-20/frontend-session-consistency-plan.md) | — | — | ✅ | — |
| [T-FE-051](../archive/2026-09-20/tasks/T-FE-051.md) | 列表加载统一错误处理+请求代际（composable 化）（✅ 2026-09-19 收口：useListLoad/usePagedList 两层 composable + toErrorMessage 统一错误文案（非 2xx 优先后端 body message，service-interface 局部副本退役）；16 加载面顺扫/收敛（user 页试点+八页代际+reqSeq/configReqSeq/treeRequestSeq 三先例收敛，matrixToken 矩阵面不收敛）；Q-017 就地化拍板收敛+启停移入 hook 透后端文案；红跑 user 7红/config 2红/pcl 1红实证；失败语义统一保留旧数据（pcl/resource-dependency 两页+biz-domain 子表刷新路径变更）；vitest 279/279 全绿；claude 外评 P0-P2=0+P3×3 全采纳处置，见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 处置行） | [frontend-session-consistency](../archive/2026-09-20/frontend-session-consistency-plan.md) | — | — | ✅ | — |
...
| T-FE-053 | 路由守卫 next() 后补 return+删 meta.roles 死分支（✅ 2026-09-19 收口：两项拍板=②+③组合（删 roles 死分支+全部 next 站点统一 return，触发面为零实证）+新建守卫 spec 首次可测化（红锁「声明 meta.roles 不再拦 403」旧实现 1 红+5 特征锁绿实证；vitest 309/309+typecheck/lint/build 全 0）；utils.ts filterNoPermissionTree 维持现状；双轨代码轨全零/文档轨 P3×1 回写；claude 外评 P0-P2=0+P3×1 头注表述限定直修+守卫单注册补锁，见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 定案/处置行） | [frontend-session-consistency](../archive/2026-09-20/frontend-session-consistency-plan.md) | — | — | ✅ | ✓ |
| [T-FE-054](../archive/2026-09-20/tasks/T-FE-054.md) | token 过期拦截器短路+过期提示（✅ 2026-09-20 收口：四项拍板〔Q-016 fire-and-forget 收口/Q-020 initRouter 无凭证分支/双分支统一提示/页面层照弹〕落地；红跑 10 红/28 绿实证；vitest 348/348+typecheck/lint/build 全 0；双轨评审代码轨 P3×3+文档轨 P3×5 逐条亲核全成立直接修；Q-016/Q-020 随卡收敛；定案见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行。claude 外评处置完毕（2026-09-20 模型 deepseek-flash[1m]：P0-P1=0、P2×1+P3×3 全成立直修——判据单源 isSessionTerminated〔含 cookie 清+userKey 残留形态〕+守卫 then 连带补 catch/代际守卫仅「另一活会话」才拦/短路 SessionExpiredError+classifySaveError 识别/401 令牌仍在才提示；红跑 5 红/73 绿；vitest 352/352；定案见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日处置行）。codex sol 复评处置完毕（2026-09-20 模型 gpt-5.6-sol xhigh：P0-P1=0、P2×2 直修〔均 claude 处置轮次生缝隙〕——终结后成功响应不回写〔sessionAlive/sessionReplaced 拆分〕+无凭证请求同短路〔无条件单源判据〕；过度设计检查可裁剪项=0〔用户叮嘱，8 机制全判定必要且最小〕；NaN fail-closed 建议不采纳〔不可达形态防御〕；红跑 2 红/30 绿+vitest 354/354；定案见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日处置行）） | [frontend-session-consistency](../archive/2026-09-20/frontend-session-consistency-plan.md) | design/frontend/login.md | — | ✅ | ✓ |
| T-FE-055 | 授予入口按钮按 MANAGE/VIEW 分文案（✅ 2026-09-20 收口：三入口文案二分「权限授予」/「查看权限」——grant-entry.ts 单源、门禁维持 ROLE:VIEW、canGrant 同批换绑授予页 SSOT 值等价；GrantMatrixPanel 授权按钮 view 态 v-if 隐藏→禁用态+tooltip 对齐 §10 表原文；三项拍板与维持现状处置见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行；spec 模块缺失红起+两态锁；vitest 356/356+typecheck/lint/build 全绿；双轨评审 P0-P2=0、P3×5（重叠计 4+1）逐条亲核属实全直修、过度设计可裁剪项=0。claude+codex sol 外评处置完毕（2026-09-20：claude deepseek-flash[1m] P0-P2=0/P3×2、codex sol xhigh P2×1/P3×2 逐条亲核——**codex P2 capability 快照不随权限热刷新重算经用户拍板根因修=canManage 响应式派生**〔§6.5「仅由门禁派生」忠实实现，grant-store 删快照字段/action，未选主体/升权虚假 tooltip 与降权可操作三形态全消；红跑 stash 快照 2 红实证〕；claude P3-1 tooltip 判据不对称随派生化消解；文案位漏扫四处直修〔quickstart 按 extension-guide 先例类推〕；看板行承载用户拍板维持惯例；存量注释×2 顺手修；过度设计=0；vitest 358/358+typecheck/lint/build 全 0；定案与明细见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日处置行）。claude 复评处置完毕（2026-09-20 复评轮 deepseek-flash[1m]：P0-P2=0/P3×3 逐条亲核——上轮五项处置逐项核实闭合；P3-2 红跑锁判别力批评成立重写为响应式桩三态翻转锁〔回退形态 1 红实证〕+P3-3 canManage 死解构直修+P3-1 降权弹窗暂态拍板登记 §6.5 边界句+存量类推 resource-dependency 四门控 computed 化〔全仓唯一孤例〕；vitest 357/357；定案见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日复评处置行） | [frontend-session-consistency](../archive/2026-09-20/frontend-session-consistency-plan.md) | design/frontend/permission-grant.md；design/frontend/role-manage.md | — | ✅ | ✓ |
| [T-FE-056](../archive/2026-09-20/tasks/T-FE-056.md) | menus 派生路由级 UX 门禁（✅ 2026-09-20 收口：gate.ts 三源判定〔menus path 集响应式派生 ∪ remaining.ts 全量白名单含参数路由前缀化 ∪ /perm/grant 显式映射 ROLE:VIEW〕+守卫状态机 uninitialized/loading/loaded/failed〔uninitialized/loading 等待初始化防冷启动深链绕过、failed fail-open、刷新失败维持 loaded 用旧 path 集〕+拦截落点全屏 /access-denied〔用户拍板，弃 /error/403 带壳〕；红跑 10 红实证+vitest 383/383+typecheck/lint/build 全 0；十册「路由可达性」口径清扫+代码注释四处〔T-PERM-037「路由可达、后端 403 兜底」退役为门禁+后端双层〕；双轨评审两轨 P0-P2=0、P3×7 全直修〔menu-retry 预清 menus×刷新失败门禁空集锁死形态用户拍板直接修——提取 menu-retry-reload.ts 失败回滚旧菜单集，主锁红跑实证〕、过度设计可裁剪项=0；定案与明细见 [历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行） | [frontend-session-consistency](../archive/2026-09-20/frontend-session-consistency-plan.md) | design/frontend/login.md 等 10 册（含 conflict-rule/permission-condition/resource-operation/resource-dependency 四册随卡补入，全清单见任务卡 design_refs） | T-FE-053 | ✅ | ✓ |
...
3. `T-PERM-021` 工作单 F 文档准确性与代码简化 — ✅ 已收口（2026-09-12）：执行门禁三项拍板（[历史定案原文](../archive/2026-09-26/decision-registry-before.md) 同日行）后七子项全处置——F1.a 清残留活计数定性收口、F1.b 盘点另立 T-PERM-065、F1.c 两列归属口径钉死、F1.d requestId 单 ID 收敛+审计两列 NOT NULL（含回归锁 6 用例）、F1.e ops runbook 新建、F1.f 死分支删除、F1.g 四副本抽取；双轨评审 P2×3+P3×13 处置；全量回归含 E2E 全绿。完成记录见任务卡。
