...
| [T-FE-054](T-FE-054.md) | token 过期拦截器短路+过期提示（✅ 2026-09-20 收口：四项拍板〔Q-016 fire-and-forget 收口/Q-020 initRouter 无凭证分支/双分支统一提示/页面层照弹〕落地；红跑 10 红/28 绿实证；vitest 348/348+typecheck/lint/build 全 0；双轨评审代码轨 P3×3+文档轨 P3×5 逐条亲核全成立直接修；守卫 then 无 catch 跨标签理论窗口登记 T-FE-056 顺手处置；Q-016/Q-020 随卡收敛；定案见 registry 同日行） | [frontend-session-consistency](../plans/frontend-session-consistency-plan.md) | design/frontend/login.md | — | ✅ | ✓ |
