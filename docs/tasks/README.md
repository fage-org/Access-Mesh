...
| [T-PERM-064](T-PERM-064.md) | 角色互斥守卫通道补全——sync/full-sync BIND 逐条守卫 + 互斥规则拒 ORG/POSITION 对（claude 外评 T-PERM-063 P2-1 核实成立，用户拍板守卫补全；口径见任务卡） | — | api-contract §5.6/§6.2.2.2；implementation §2.4；AGENTS.md | — | 🔨 | ⏳ |
