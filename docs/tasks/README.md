...
| [T-PERM-061](T-PERM-061.md) | EXT-7：batchCheck 逐条 engine.query 收敛——A+ 形态「分组 + 请求级共享装载」（设计稿 v4 2026-09-11：首轮双评 + 三轨复审 + codex sol 第三轮处置，**待用户确认定稿**；实施未开始） | — | implementation §3；api-contract §6.1 | — | ⚙️ | ⏳ |
