...
| [T-PERM-061](T-PERM-061.md) | EXT-7：batchCheck 逐条 engine.query 收敛——A+ 形态「分组 + 请求级共享装载」（设计定稿 v4 2026-09-11 用户确认：四轮外评处置完毕，已回写 implementation §3.10；实施未开始） | — | implementation §3；api-contract §6.1 | — | ⚙️ | ⏳ |
