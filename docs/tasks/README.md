...
| [T-FE-059](T-FE-059.md) | 共享列表上下文与可写对象绑定 | ✅（2026-09-23 收口：loader contextKey/clear/onClear 四消费面接线+保存时核对层拍板「加」〔12 处守卫〕；双轨评审 P1 哨兵归一/P2 submitMove 直修红跑实证、过度设计=0；vitest 432/432+typecheck/lint/build 0+浏览器三截图证据；定案见 registry 同日行） | — |
...
| [T-PERM-073](T-PERM-073.md) | 按需来源解释、授权界面与对账 | —（自动授权实施序列） | [简化设计](../design/dependency-auto-grant.md) | T-PERM-072 | ✅ | ✅ |
