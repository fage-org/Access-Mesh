...
- `docs/plans/improvement-plan.md` §3.1 痛点 #4 — 已标暂缓（2026-06-20 审计 S-026）

## 背景

动态数据权限：按身份 ID 的数据范围筛选（普通员工看本人、团队管理者看本团队、部门总监看本部门）。设计已存在（条件评估、数据范围），但端到端链路未验证。对应 improvement-plan §3.1 痛点 #4。

## 验证步骤（improvement-plan §2.3）
