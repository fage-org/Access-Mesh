...
- **回归证据**：`mvn test -pl access-service -DskipTestcontainers=true`（2026-09-21，1308 项 0 失败）；`mvn test -pl access-service -Dtest=AutoGrantMaterializationPgIT`（2026-09-21，17 项 0 失败）；收口全量 `mvn clean test -T 1C`（2026-09-21，BUILD SUCCESS——单测 1308 + 容器 286 + E2E 15 全绿，评审修复批后复跑全量同为 BUILD SUCCESS）。
