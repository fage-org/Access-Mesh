...
- 测试：后端 ConditionAppServiceImplTest 23 项全绿（16 适配 + 7 新增）+ HttpApiPathSnapshotTest 7 项全绿（含订正 2 行）；前端 vue-tsc 干净 + vitest 216 项全绿 + 变更文件 eslint 干净。
