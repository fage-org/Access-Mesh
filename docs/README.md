...
| 主题 | 文档 |
|------|------|
| access-service 能力包融合 | [plans/access-capability-fusion-plan.md](plans/access-capability-fusion-plan.md)（proposed，2026-09-13 立项；目标设计 [design/access-service-capability-structure.md](design/access-service-capability-structure.md)） |
