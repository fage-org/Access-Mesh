...
计划已 active，T-PERM-074、T-PERM-078、T-ORG-002、T-PERM-075、T-ADMIN-028 已 done（T-ORG-002 2026-09-21 收口：U001 拒绝+人数/树配置最小面+set-default 严格判定三项拍板见 registry 同日行；T-PERM-075 2026-09-22 收口：U002 两项拍板与共同判定语义取代见 registry 同日两行；T-ADMIN-028 2026-09-22 收口：授权码客户端关联校验最小面+CHANGELOG 补条目拍板见 registry 同日行，双轨评审 P0-P2=0），衔接的自动授权序列 T-PERM-071/072/073 已全部收口（2026-09-21，含 T-PERM-079 风格清理单卡归档），其余任务状态见任务清单。自动授权简化方向已 adopted，078 已完成设计 M1～M5 校准，072/073 验收已衔接；其他任务待决项维持原安排。已有问题/在途事项的去重与承接见[评审证据映射](../archive/2026-09-20/comprehensive-review.md)。
