...
| [perm-cache-invalidation-plan.md](perm-cache-invalidation-plan.md) | P0 落地计划（工作单 A）| 进行中 | 权限缓存失效改造：Gateway 快照模式 + ThreadLocal 影响范围收集 + 删除 permission_version + Redis pub/sub 广播。关联审计 S-001/S-006。任务 T-PERM-001·002·003·004·005·006·007·008·017·018 done |
| [scope-mode-migration-plan.md](scope-mode-migration-plan.md) | P0 落地计划（工作单 B）| 进行中 | scopeMode 协议全量推广（响应四态、请求二态；运行时 + 管理端 + 排查页），替换 scopeAll boolean。关联审计 S-005。任务 T-PERM-009·010·011·012·014 done / 013·015 proposed |
| [gateway-fail-mode-plan.md](gateway-fail-mode-plan.md) | P0 落地计划（工作单 C）| 进行中 | Gateway 失联兜底：三模 fail-mode（closed/open/stale-allow）+ 监控指标。关联审计 S-006（已设计 T-GW-005，T-PERM-008 代码基础设施已落地）；依赖工作单 A 快照模式。任务 T-GW-001·002·003·004·005·006 done（T-GW-006 重新界定为独立仓库测试服务） |
