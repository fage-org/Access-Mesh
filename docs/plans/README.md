...
| [scope-mode-migration-plan.md](scope-mode-migration-plan.md) | P0 落地计划（工作单 B）| 进行中 | scopeMode 协议全量推广（响应四态、请求二态；运行时 + 管理端 + 排查页），替换 scopeAll boolean。关联审计 S-005。任务 T-PERM-009·010·011·014 done / 012·013·015 proposed |
