...
| [gateway-fail-mode-plan.md](gateway-fail-mode-plan.md) | P0 落地计划（工作单 C）| 进行中 | Gateway 失联兜底：三模 fail-mode（closed/open/stale-allow）+ 监控指标。关联审计 S-006（已设计 T-GW-005，T-PERM-008 代码基础设施已落地）；依赖工作单 A 快照模式。任务 T-GW-001·002·003·004·005 done / T-GW-006 proposed |
