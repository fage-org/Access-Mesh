...
| [perm-cache-invalidation-plan.md](perm-cache-invalidation-plan.md) | P0 落地计划（工作单 A）| 进行中 | 权限缓存失效改造：Gateway 快照模式 + ThreadLocal 影响范围收集 + 删除 permission_version + Redis pub/sub 广播。关联审计 S-001/S-006。任务 T-PERM-001·002·003·018 done / 004~008·017 proposed |
