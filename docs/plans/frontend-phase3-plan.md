...
| T-FE-016 ✅ | 角色管理（2.2；api 层 T-FE-041 已真实路径，本任务收口 Gateway +4 端点注册/编辑 extra 回显 detail 回填 + extraClear 清空协议（两项设计定案）/mock 退役删除/业务门禁零新增（ROLE 全档在图）；已收口 2026-09-01，终态见任务卡完成记录） | T-FE-002, T-PERM-022 |
