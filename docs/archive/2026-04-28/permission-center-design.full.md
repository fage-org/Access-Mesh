...
本文档是 2026-04-28 文档重整前的旧版完整设计，仅用于历史追溯。实现时请以 `plan/permission-center/overview.md`、`plan/permission-center/api-contract.md`、`plan/permission-center/core-flows.md` 和 `plan/schema/permission-center.sql` 为准。
