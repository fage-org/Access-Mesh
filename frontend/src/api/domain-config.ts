/**
 * 域配置 API
 * 经 @/utils/http 调用 access-service 端点（`/api/access/domain-config/*`，Gateway /perm 前缀——T-FE-021 切换）；
 ...
 *
 * 契约依据：docs/design/access-service-api-contract.md §14.2（domain-config）
